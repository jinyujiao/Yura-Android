...
public class ExtraFieldUtils {
        ...
        if (c != null) {
            try {
                ...
                final InstantiationException exception =
                    new InstantiationException("Unable to instantiate zip extra field " + c.getName());
    ...
    public static void register(final Class<?> c) {
        ...
        } catch (final InstantiationException | InvocationTargetException ie) { // NOSONAR
            throw new IllegalArgumentException(c + " is not a concrete class"); //NOSONAR
        } catch (final IllegalAccessException | NoSuchMethodException ie) { // NOSONAR
